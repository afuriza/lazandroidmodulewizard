...
exports
  ...
  pOnDown name
    'Java_com_example_appbluetoothclientsocketdemo1_Controls_pOnDown',
  ...
  pOnLongClick name 'Java_com_example_appbluetoothclientsocketdemo1_Controls_'
    +'pOnLongClick',
  pOnDoubleClick name 'Java_com_example_appbluetoothclientsocketdemo1_Controls'
    +'_pOnDoubleClick',
  ...
  pOnEnter name 'Java_com_example_appbluetoothclientsocketdemo1_Controls_'
    +'pOnEnter',
  pOnBackPressed name 'Java_com_example_appbluetoothclientsocketdemo1_Controls'
    +'_pOnBackPressed',
  ...
  pOnClickImageItem name 'Java_com_example_appbluetoothclientsocketdemo1_'
  ...
  pOnClickItemTextLeft name 'Java_com_example_appbluetoothclientsocketdemo1_'
    +'Controls_pOnClickItemTextLeft',
  pOnClickItemTextCenter name 'Java_com_example_appbluetoothclientsocketdemo1_'
    +'Controls_pOnClickItemTextCenter',
  pOnClickItemTextRight name 'Java_com_example_appbluetoothclientsocketdemo1_'
  ...
  pOnListViewDrawItemBackgroundColor name 'Java_com_example_appbluetoothclients'
    +'ocketdemo1_Controls_pOnListViewDrawItemBackgroundColor',
  ...
  pOnListViewDrawItemWidgetText name 'Java_com_example_appbluetoothclientsocket'
    +'demo1_Controls_pOnListViewDrawItemWidgetText',
